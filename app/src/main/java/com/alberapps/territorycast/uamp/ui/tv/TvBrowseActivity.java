...
public class TvBrowseActivity extends FragmentActivity
    ...
    public static final String SAVED_MEDIA_ID="com.alberapps.territorycast.uamp.MEDIA_ID";
    public static final String BROWSE_TITLE = "com.alberapps.territorycast.uamp.BROWSE_TITLE";
