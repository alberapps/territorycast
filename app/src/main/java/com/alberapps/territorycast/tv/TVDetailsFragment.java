...
import com.alberapps.territorycast.MainActivity;
...
public class TVDetailsFragment extends DetailsFragment {
    ...
    private Programa mSelectedPrograma;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSelectedPrograma =
                (Programa) getActivity().getIntent().getSerializableExtra(TVDetailsActivity.MOVIE);
        if (mSelectedPrograma != null) {
            ...
            setAdapter(mAdapter);
            initializeBackground(mSelectedPrograma);
    ...
    private void initializeBackground(Programa data) {
    ...
    private void setupDetailsOverviewRow() {
        Log.d(TAG, "doInBackground: " + mSelectedPrograma.toString());
        final DetailsOverviewRow row = new DetailsOverviewRow(mSelectedPrograma);
        row.setImageDrawable(
                ContextCompat.getDrawable(getActivity(), R.drawable.default_background));
        int width = convertDpToPixel(getActivity().getApplicationContext(), DETAIL_THUMB_WIDTH);
        int height = convertDpToPixel(getActivity().getApplicationContext(), DETAIL_THUMB_HEIGHT);
        Glide.with(getActivity())
                .load(mSelectedPrograma.getCardImageUrl())
                .centerCrop()
                .error(R.drawable.default_background)
    ...
    private void setupDetailsOverviewRowPresenter() {
        ...
        sharedElementHelper.setSharedElementEnterTransition(
                getActivity(), TVDetailsActivity.SHARED_ELEMENT_NAME);
        ...
        detailsPresenter.setOnActionClickedListener(new OnActionClickedListener() {
            ...
            public void onActionClicked(Action action) {
                if (action.getId() == ACTION_WATCH_TRAILER) {
                    ...
                    intent.putExtra(TVDetailsActivity.MOVIE, mSelectedPrograma);
                    startActivity(intent);
                } else {
    ...
    private void setupRelatedMovieListRow() {
        ...
        List<Programa> list = ProgramaList.getList();
    ...
    private final class ItemViewClickedListener implements OnItemViewClickedListener {
        ...
        public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item,
            ...
            if (item instanceof Programa) {
                ...
                intent.putExtra(getResources().getString(R.string.programa), mSelectedPrograma);
